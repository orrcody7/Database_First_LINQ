...
namespace DatabaseFirstLINQ
{
    class Problems
    {
        ...
        private void ProblemFour()
        {
            ...
            var products = _context.Products;
            var productNameThatContainsAnS = products.Where(p => p.Name.Contains("s"));
            foreach (var product in productNameThatContainsAnS)
            {
        ...
        private void ProblemFive()
        {
            ...
            var userRegisteredBefore = registeredUsers.Where(u => u.RegistrationDate < date);
            foreach (var user in userRegisteredBefore)
            {
        ...
        private void ProblemSix()
        {
            ...
            var registeredUsersBetweenDate = registeredUsers.Where(u => beforeDate > u.RegistrationDate && u.RegistrationDate > afterDate);
            foreach (var user in registeredUsersBetweenDate)
            {
                Console.WriteLine(user.Email + " " + user.RegistrationDate);
            }
        }
        ...
        private void ProblemNine()
        {
            ...
            Console.WriteLine("Oda's shopping cart:");
            var customerCart = _context.ShoppingCarts.Include(ur => ur.User).Include(ur => ur.Product).Where(ur => ur.User.Email == "oda@gmail.com");
            foreach (ShoppingCart shoppingCart in customerCart)
            {
                Console.WriteLine(shoppingCart.Product.Name + " " + shoppingCart.Product.Price + " " + shoppingCart.Quantity);
            }
            var allProducts = _context.ShoppingCarts.Include(ur => ur.User).Include(ur => ur.Product).Where(ur => ur.User.Email == "oda@gmail.com").Select(sc => sc.Product.Price).Sum();
            {
                Console.WriteLine("Total:" + "$" + allProducts);
            }
        }
        ...
        private void ProblemTwelve()
        {
            ...
            {
                Name = "Hair Scrunchie",
                Description = "Lush forest green- 100% Polyester",
                Price = 3
        ...
        private void ProblemFourteen()
        {
            ...
            var productId = _context.Products.Where(p => p.Name == "Hair Scrunchie").Select(p => p.Id).SingleOrDefault();
            var userId = _context.Users.Where(u => u.Email == "david@gmail.com").Select(u => u.Id).FirstOrDefault();
        ...
        private void ProblemEighteen()
        {
            ...
            var deleteUser = _context.UserRoles.Where(du => du.User.Email == "oda@gmail.com").SingleOrDefault();
